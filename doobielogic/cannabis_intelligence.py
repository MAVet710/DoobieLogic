...
def build_doobie_context(data: dict[str, Any] | None, mode: str, question: str = "", state: str | None = None) -> dict[str, Any]:
    payload = data or {}
    ...
    department_knowledge = search_department_knowledge(dept, question or safe_mode, limit=5)
    source_context = build_grounded_summary(question=question or safe_mode, state=state, module="operations")
