...
_ENTRIES: tuple[DepartmentKnowledgeEntry, ...] = (
    ...
    DepartmentKnowledgeEntry("buyer", "aging inventory", "Aging inventory needs staged markdown discipline", "Delayed markdowns can compound carrying cost and destruction exposure.", "Use staged markdown ladders before inventory ages out.", "heuristic_operational_pattern", "medium", ("aging", "markdown", "inventory")),
    DepartmentKnowledgeEntry("buyer", "sku rationalization", "Duplicate SKUs reduce menu clarity", "Too many similar SKUs can lower conversion and inflate inventory risk.", "Rationalize duplicate positioning by brand/price/format.", "heuristic_operational_pattern", "medium", ("sku", "rationalization", "duplicate", "menu")),
    DepartmentKnowledgeEntry("buyer", "promo discipline", "Promotion should have clear objective", "Promos without traffic or liquidation goals often destroy margin quality.", "Require objective and post-promo review on each campaign.", "grounded_operational_reference", "high", ("promo", "discount", "margin")),
    DepartmentKnowledgeEntry("buyer", "case pack", "Case pack sizes can create hidden overbuying", "Large case packs can force excess days-on-hand in slower stores.", "Match case pack and MOQ decisions to store velocity profile.", "heuristic_operational_pattern", "medium", ("case pack", "moq", "overbuy")),
    DepartmentKnowledgeEntry("buyer", "menu architecture", "Menu architecture should align with shopper decision flow", "Poorly structured menus reduce discoverability and attach.", "Group by category, format, and price tier with clean naming.", "heuristic_operational_pattern", "medium", ("menu", "taxonomy", "format", "shopper")),
    DepartmentKnowledgeEntry("buyer", "lifecycle", "SKU lifecycle needs active management", "Launch and decline stages require different buying behavior.", "Use lifecycle tags to trigger expansion, hold, or exit decisions.", "grounded_operational_reference", "high", ("lifecycle", "launch", "decline")),
    DepartmentKnowledgeEntry("buyer", "turns vs margin", "Margin should be balanced with turns", "High margin with weak turns can still destroy cash efficiency.", "Evaluate GMROI and carrying cost with margin metrics.", "grounded_operational_reference", "high", ("turns", "margin", "gmroi", "carrying cost")),
    # Cultivation
